...
def detect(model,
    ...
    for img, im0s in dataset:
        ...
        frame_bboxes = []  # List to store bbox information for this frame
        # Process detections
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                # Append bbox information for this frame to the frame_bboxes list
                frame_bboxes.append(bbox_xywh)
                ...
                im0=draw_masks_randbox_darkSB(im0, det[:, :4],cifar_img=cifar_img,return_rand=False)
                #rand_sum +=randnum
    ...
    # Convert all_bboxes to a NumPy array for easy access
    #print(all_bboxes)
    all_bboxes = np.array(all_bboxes,dtype=object)
    ...
    if return_randsum:
        ...
        return stacked_result, all_bboxes
